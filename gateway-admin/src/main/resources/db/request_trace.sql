-- Request trace table for traffic topology and request replay
-- Stores HTTP request trace data for analysis

CREATE TABLE IF NOT EXISTS gateway_request_trace (
...
-- Add partitioning for large datasets (optional)
-- ALTER TABLE gateway_request_trace PARTITION BY RANGE (TO_DAYS(trace_time)) (
